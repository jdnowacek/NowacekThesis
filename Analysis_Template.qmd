...
# FIX: Map these to the exact names exported by the list in get_simulated_truth()
density <- truth$density
population_description <- truth$population_description
population <- truth$population
detectability <- truth$detectability
```
