...
ggplot() + 
  ...
  geom_point(data = truth$population@population |> mutate(detected = individual %in% survey_data$dist_data$individual[!is.na(survey_data$dist_data$distance)]), 
...
B1 <- 10 # Set appropriately for your full run
